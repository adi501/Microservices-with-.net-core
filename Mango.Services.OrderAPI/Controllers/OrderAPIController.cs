...
namespace Mango.Services.OrderAPI.Controllers
{
    ...
    public class OrderAPIController : ControllerBase
    {
        ...
        public OrderAPIController(AppDbContext db, IMapper mapper, IProductService productService, IRabbmitMQOrderMessageSender messageBus, IConfiguration configuration)
        {
            _db = db;
